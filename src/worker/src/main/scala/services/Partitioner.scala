...
object Partitioner {
  ...
  private val PartitionSearchComparator: Comparator[Any] = new Comparator[Any] {
    override def compare(o1: Any, o2: Any): Int = {
      // o2: binarySearch의 keyToFind (RecordKey 타입)
      // o1: binarySearch가 배열에서 비교하는 요소 (PartitionRange 타입)
      
      val keyToFind = o2.asInstanceOf[RecordKey]
      
      // o2가 PartitionRange 타입인지 확인합니다.
      o1 match {
        case range: PartitionRange =>
